function showCustomAlert() {
  ...
  heading.style.color = '#0026FF'; // Color for the heading text
  heading.style.fontSize = '24px'; // Adjust font size if needed
  heading.style.fontFamily = '"Poppins", sans-serif'; // Use Google Font Poppins

  // Create the message
  const message = document.createElement('p');
  message.textContent = 'Switch to an Instagram tab, visit a user profile, and click the extension again.';
  message.style.color = '#666';
  message.style.width = '80%';
  message.style.margin = 'auto';
  message.style.fontFamily = '"Poppins", sans-serif'; // Use Google Font Poppins
